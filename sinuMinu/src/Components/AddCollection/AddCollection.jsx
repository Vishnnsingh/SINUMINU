...
const AddCollection = () => {
  ...
  return (
    <div className="  p-4 pb-10 bg-transparent   ">
      <h1 className="text-4xl font-bold text-center relative text-amber-600 mb-16">
        Welcome to Our Aniamtion World!
      </h1>

      <div className="bg-white  rounded-lg border-l-8 border-blue-600 p-4 text-center ">
        <h2 className="text-3xl relative font-bold text-[rgb(35, 36, 69)] ">
