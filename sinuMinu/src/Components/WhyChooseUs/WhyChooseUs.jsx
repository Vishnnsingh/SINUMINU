            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12 border-r-8 border-r-blue-600">
              <div className="mt-10  relative lg:mt-0">
                ...
                {/* <a
                  ...
                  className="inline-flex items-center justify-center py-3 text-base font-medium text-center text-amber-700 border border-transparent rounded-md px-7 bg-primary hover:bg-opacity-90"
                >
                  Get Started
                </a> */}
              </div>
